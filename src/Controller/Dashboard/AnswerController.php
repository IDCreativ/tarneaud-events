...
class AnswerController extends AbstractController
{
    ...
    {
        return $this->render('dashboard/answer/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->renderForm('dashboard/answer/new.html.twig', [
            'answer' => $answer,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('dashboard/answer/show.html.twig', [
            'answer' => $answer,
        ]);
    }
    ...
    public function edit(Request $request, Answer $answer): Response
    {
        ...
        return $this->renderForm('dashboard/answer/edit.html.twig', [
            'answer' => $answer,
            'form' => $form,
        ]);
    }
