...
class FeedbackController extends AbstractController
{
    ...
    public function new(Request $request, FeedbackRepository $feedbackRepository): Response
    {
        ...
        return $this->renderForm('dashboard/feedback/new.html.twig', [
            'feedback' => $feedback,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('dashboard/feedback/show.html.twig', [
            'feedback' => $feedback,
        ]);
    }
    ...
    public function edit(Request $request, Feedback $feedback, FeedbackRepository $feedbackRepository): Response
    {
        ...
        return $this->renderForm('dashboard/feedback/edit.html.twig', [
            'feedback' => $feedback,
            'form' => $form,
        ]);
    }
