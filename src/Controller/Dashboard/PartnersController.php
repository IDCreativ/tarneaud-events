...
class PartnersController extends AbstractController
{
    ...
    {
        return $this->render('dashboard/partners/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->renderForm('dashboard/partners/new.html.twig', [
            'partner' => $partner,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('dashboard/partners/show.html.twig', [
            'partner' => $partner,
        ]);
    }
    ...
    public function edit(Request $request, Partners $partner): Response
    {
        ...
        return $this->renderForm('dashboard/partners/edit.html.twig', [
            'partner' => $partner,
            'form' => $form,
        ]);
    }
